...
export const Contact = () => {
  ...
  return (
      <StyledContact id='contact-form'>
            {submitted ? <span className="alert">Thank you for your request. I will be in touch soon</span> : null}
            <label>Name:</label>
            <input type='text' placeholder='John Doe' value={name} onChange = {(e) => {setName(e.target.value)}}/>
            <label>Email:</label>
            <input type='email' placeholder='johndoe@comapny.com' value={email} onChange = {(e) => {setEmail(e.target.value)}}/>
            <label>Message:</label>
